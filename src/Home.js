...
class Home extends Component {
  render() {
    return (
      <div className="mid container mb-5">
        ...
        >
          <i class="fas fa-layer-group" /> Full-stack engineer that loves building
          responsive, user-friendly websites using modern technologies like{' '}
          <i class="fab fa-react" /> React and <i class="fab fa-node-js" />{' '}
          Node.js! Please check out my <i class="fas fa-file" />{' '}
          <a href={resume} target={'_blank'}>
            {' '}
            resume
          </a>{' '}
          or my <NavLink to="/about">about</NavLink> and{' '}
